...
from .views import login_view, signup_view, home, aboutus, service, profile, logout_view, appointment_list, uproduct_list, product_details, add_to_cart, remove_from_cart, cart, checkout, order_confirmation, payment_method, process_payment, confirm_payment, edit_profile, product_reviews, rate_product
